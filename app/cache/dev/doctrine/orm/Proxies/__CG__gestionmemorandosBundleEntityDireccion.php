 ...
 */
class Direccion extends \gestion\memorandosBundle\Entity\Direccion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdDireccion()
    {
        if ($this->__isInitialized__ === false) {
            return $this->_identifier["idDireccion"];
        }
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'idDireccion', 'direccion', 'ciudad');
    }
